...
export namespace Permission {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@reaslab-agent/Permission") {}
  ...
  export function fromConfig(permission: Record<string, Action | Record<string, Action>>) {
